...
class oZetaNSS(ConfigListScreen, Screen):
    ...
    def createSetup(self):
        ...
        # sep = "-"
        try:
            self.list.append(getConfigListEntry(_("NONSOLOSAT SKIN OPTIONS"), config.ozetanss.fake, _("GENERAL SECTION")))
